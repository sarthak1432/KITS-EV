export default function Footer({ scooterCatalog, navigationLinks, openModels, currentYear, scrollToTop }) {
  return (
    <footer id="footer" className="reveal mt-10 rounded-[2.5rem] border border-white/90 bg-[linear-gradient(180deg,_rgba(15,23,42,0.98)_0%,_rgba(30,41,59,0.98)_100%)] p-6 sm:p-10 lg:p-16 text-white shadow-[0_32px_90px_rgba(15,23,42,0.25)]">
      <div className="grid gap-12 lg:grid-cols-[1.2fr_0.8fr_0.8fr_1fr] lg:gap-16">
        {/* 1. Brand Identity */}
        <div className="space-y-8">
          ...
          >
            ...
            <h2 className="mt-3 font-display text-2xl font-bold leading-tight tracking-tight text-white sm:text-4xl">
              Elevating the EV <br /> 
          ...
          <div className="flex items-center gap-4">
            <div className="h-12 w-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-xl shadow-inner">⚡</div>
            <div>
              <p className="text-[10px] font-bold uppercase tracking-widest text-slate-500">Tech Ready</p>
              <p className="text-xs text-slate-400">Advanced diagnostic support</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-6">
            <a 
              ...
              target="_blank" 
              rel="noreferrer"
              className="group flex gap-4 rounded-2xl border border-white/5 bg-white/2 p-4 transition hover:bg-white/5"
            >
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-amber-500/10 text-amber-500 group-hover:bg-amber-500 group-hover:text-white transition-colors">
                📍
              </div>
              <div>
                <p className="text-[10px] font-bold uppercase tracking-widest text-slate-500">Workshop</p>
                <p className="mt-1 text-xs leading-5 text-slate-300">Mukta plaza, Income Tax Square, Akola</p>
              </div>
            </a>

            <div className="group flex gap-4 rounded-2xl border border-white/5 bg-white/2 p-4 transition hover:bg-white/5">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-emerald-500/10 text-emerald-500 group-hover:bg-emerald-500 group-hover:text-white transition-colors">
                📞
              </div>
              <div>
